...
<div class="container w-50 h-100 mt-5 self-center">
    <div class="row col-sm-12 col-md col-lg mx-auto">
    ...
    <div class="row col-sm-12 col-md-6 col-lg-6 mx-auto">
        <div class="info-box col align-self-center">
            <p class="text">Estado: </p>
            <div style="font-weight: 700">{{$usuario->status}}</div>
        </div>
    </div>
        <a href="{{ route( 'my_profile.edit' ) }}"><button class="Editar col-12 mt-4">Modificar
                Datos</button></a>
</div>
@if(session('success'))
